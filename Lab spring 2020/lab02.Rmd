...
```{r}
n=1000
v=sample(rnorm(n, mean = -10, sd = sqrt(100)))
...
#yes, because the mean of v is -9.09 which is 50%tile, -25 is good estimation
```
...
# yes, because p(x < -10) = 50%, should around 80% when P(x < 0). it is expected from the theory
```
