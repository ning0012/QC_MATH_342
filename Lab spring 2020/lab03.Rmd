...
#'
#' @param Xinput      TO-DO: The training data features as an n x p matrix.
#' @param y_binary    TO-DO: The training data responses as a vector of length n consisting of only 0's and 1's.
#' @param MAX_ITER    TO-DO: he maximum number of iterations the algorithm perform
